        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <div class="nav-item navbar-search-wrapper mb-0">
                    <div class="form-group">
                        <select name="active_lang" id="active_lang" class="select2 form-select2"
                            data-placeholder="Select Language" onchange="changeLanguage()">
                            @foreach (activeLanguages() as $language)
                                <option value="{{ $language->code }}"
                                    {{ $language->code == \Cache::get('locale') ? 'selected' : '' }}>{{ $language->name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    {{-- <li>
                        <a class="dropdown-item" href="{{route('cms.faq.index')}}">
