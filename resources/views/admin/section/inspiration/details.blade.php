...
@section('title', $title ?? _trans('portfolio.Inspiration').' '._trans('portfolio.Details'))

@section('content')

    <div class="container-xxl flex-grow-1 container-p-y" id="content-wrapper">
        {!! breadcrumb(_trans('portfolio.Inspiration').' '._trans('portfolio.Details'),['section/portfolioAndInspiration/2/index'=>_trans('portfolio.Portfolio').' & '._trans('portfolio.Inspiration'),'inspiration'=>_trans('portfolio.Inspiration').' '._trans('portfolio.Details')]) !!}
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="card-title mb-0">{{_trans('portfolio.Select Section For Inspiration Details')}}</h5>
            </div>
            <div class="row card-body justify-content-center align-items-center">
                <div class="col-8 ecommerce-select2-dropdown">
                    <select id="design_input" class="select2 form-select" data-placeholder="Select Section">
                        ...
                        <option value="image_gallary">{{_trans('portfolio.Images Gallary')}}</option>
                        <option value="image_gallary_with_details">{{_trans('portfolio.Gallery With Details')}}</option>
                        <option value="banner_image">{{_trans('portfolio.Landscape Banner')}}</option>
                    </select>
                </div>
                @if(hasPermission('add_inspiration_section'))
                    <div class="col-4">
            ...
            @if ($detail->section_type == 'image_gallary_with_details')
                <div class="card mb-4 section" data-id="image_gallary_with_details">
                    <div class="card-header d-flex flex-row justify-content-start align-items-center">
                        <h5 class="card-title mb-0">{{_trans('portfolio.Image Gallary With Details')}}</h5>
            ...
            @if ($detail->section_type == 'banner_image')
                @foreach ($detail->items as $item)
                    <div class="card mb-4 section" data-id="banner_image">
                        <div class="card-header">
                            <h5 class="card-title mb-0">{{_trans('portfolio.Landscape Banner')}}</h5>
                            <input type="text" value="{{ $detail->id }}" hidden>
                        </div>
