...
@section('title', $title ?? _trans('order.Cart Details')))

@section('content')


    <div class="container-xxl flex-grow-1 container-p-y">
        {!! breadcrumb(_trans('order.Cart Details'), ['#' => _trans('order.Order').' '. _trans('product.Management'), '##'=>_trans('order.Customer').' '._trans('order.Order'), 'cart' => _trans('order.Cart Details')]) !!}
        ...
        <form action="{{ route('order.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-8">
                        ...
                        <div class="card-datatable table-responsive">
                            ...
                            <div class="d-flex flex-column justify-content-end align-items-end m-3 mb-2 p-1">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <div class="d-flex me-4 w-px-300">
                                        <select name="discount_type" class="form-select me-2 charges" id="discount_type"
                                            ...
                                            <option value="2">{{_trans('order.Fixed Amount')}}</option>
                                        </select>
                                ...
                                <div class="d-flex justify-content-between w-px-300 border-top pt-2">
                                    <h4 class=" mb-0">{{_trans('common.Total')}}:</h4>
                    ...
                    @if(hasPermission('customer_cart_list_update'))
                        ...
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <h6 class="m-0">
                                <a href=" javascript:void(0)" data-bs-toggle="modal"
                                    data-bs-target="#addNewAddress">{{_trans('common.Add')}}</a>
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                ...
                <div class="modal-content p-3 p-md-5">
                    <div class="modal-body">
                        ...
                        <div class="text-center mb-4">
                            <h3 class="address-title mb-2">{{_trans('order.Add New Address')}}</h3>
                            <p class="text-muted address-subtitle">{{_trans('order.Add new address for Shipping')}}</p>
                        </div>
                        <form id="addNewAddressForm" class="row g-3" method="POST" action="{{route('shippingAddress.store')}}">
                            ...
                            <div class="col-12">
                                <label class="form-label" for="modalAddressAddress1">{{_trans('common.Street Address')}}</label>
                                <input type="text" required id="modalAddressAddress1" name="modalAddressStreet"
                                    class="form-control" placeholder="12, Business Park" />
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label" for="modalAddressLandmark">{{_trans('common.State')}}</label>
                                <input type="text" required id="modalAddressState" name="modalAddressState"
                                    class="form-control" placeholder="California" />
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label" for="modalAddressZipCode">{{_trans('common.Zip Code')}}</label>
