:root {
    ...
    --color-button-bg: {{ colorTheme()->button_bg_color }};
    --color-button-text: {{ colorTheme()->button_text_color }};
    --color-hover: {{ colorTheme()->hover_color }};
    --color-border: {{ colorTheme()->border_color }};
    --color-text: {{ colorTheme()->text_color }};
