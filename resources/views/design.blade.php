        ...
        <section class="container mx-auto mt-[40px]">
            <div class="grid grid-cols-2">
                ...
                <div class="product_id">
                    ...
                    <p class="capitalize inter-700 text-2xl text-wrap md:text-3xl lg:text-4xl mb-[10px] mt-[60px]">Popular
                    </p>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div
                            ...
                            <div class="flex flex-col justify-between  leading-normal w-full p-4">
                                <h5 class="text-2xl font-bold tracking-tight text-gray-900">Beef Tehari</h5>
                                <h4 class="font-semibold text-[#E32938]">From tk 136</h4>
                                <p class="mb-3 font-normal text-gray-700">One pot meal with special aromatic
                                    spices</p>

                            </div>

                            <img class="p-2 object-contain w-full rounded-t-lg h-36 md:w-48 md:rounded-none md:rounded-e-lg"
                                 src="https://placehold.co/300x200?text=demo image" alt="Demo Food image">
                            <button
                                class=" mr-2 ml-2 p-6 text-[#E32938] text-2xl font-bold cart_increment_button border border-[#E32938] w-12 h-12 rounded-full flex items-center justify-center hover:bg-[#E32938] hover:text-white transition-colors duration-200">+</button>
                        </div>
                        ...
                        <div
                            ...
                            <img class="p-2 object-contain w-full rounded-t-lg h-36 md:w-48 md:rounded-none md:rounded-e-lg"
                                 src="https://placehold.co/300x200?text=demo image" alt="Demo Food 1">
                            <button
                                class=" mr-2 ml-2 p-6 text-[#E32938] text-2xl font-bold cart_increment_button border border-[#E32938] w-12 h-12 rounded-full flex items-center justify-center hover:bg-[#E32938] hover:text-white transition-colors duration-200">+</button>
                        </div>
                    </div>
                ...
                {{-- <div class="cart_list flex justify-center items-start">
                    <form method="GET" action="{{route('checkout')}}">
                        <p class="capitalize inter-700 text-2xl w-[100%] text-wrap md:text-3xl lg:text-4xl mb-[40px] bg-[#E53D4B] text-white p-2 rounded">Delivary</p>
                ...
                <div class="max-w-md mx-auto bg-white mt-40 rounded-lg border border-gray-200 shadow-md p-4">
                    <!-- Header -->
...
<div class="max-w-md mx-auto bg-white mt-40 rounded-lg border border-gray-200 shadow-md p-4">
                    ...
                    <div class="p-8 text-center">
                        ...
                        <button class="text-red-500 border border-red-500 px-6 py-2 rounded-full hover:bg-red-500 hover:text-white transition-colors duration-300">
                            Browse Menu
                        </button>
                    </div>

                    <!-- Your Items (Add a hidden class when cart is empty) -->
                    <div class="p-4 hidden">
                        <!-- ... rest of your existing cart items code ... -->
                    </div>
                </div>
...
--}}
                    ...
                    <div class="p-4">
                        ...
                        <div class="space-y-4">
                            <!-- Repeat this item as needed -->
                            <div class="flex items-center justify-between border-b pb-2">
                                <div class="flex items-center">
                                    <img src="https://via.placeholder.com/50" alt="Item Image"
                                         class="w-12 h-12 rounded-full">
                                    <div class="ml-3">
                                        <h4 class="font-medium text-sm">One Pot Meal With Special Aromatic Spices</h4>
                                        <p class="text-xs text-gray-500">For 1 Person</p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <p class="text-red-500 font-semibold text-sm">Tk 136</p>
