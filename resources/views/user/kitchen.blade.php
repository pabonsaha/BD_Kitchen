        ...
        <section class="container mx-auto mt-10">
            <div class="grid grid-cols-2">
                ...
                <div class="product_id">
                    ...
                    <p class="capitalize inter-700 text-2xl text-wrap md:text-3xl lg:text-4xl mb-[10px] ">
                        Popular
                    </p>
                    <p class="mb-3 font-normal  text-gray-700">Most ordered right now.</p>
                    <div class="grid grid-cols-1 gap-4">
                        @foreach ($products as $product)
                            <div
                                ...
                                <button
                                    class="mx-4 my-4 p-4 text-[#E32938] text-2xl font-bold add_to_cart_button border border-[#E32938] w-12 h-12 rounded-full flex items-center justify-center hover:bg-[#E32938] hover:text-white transition-colors duration-200">
                                    +
                                </button>
                ...
                <div class="max-w-md w-100 bg-white mt-20 rounded-lg border border-gray-200 shadow-md p-4">
...
@push('script')
    <script>
        ...
        $(document).on('click', '.cart_increment_button', function(e) {
            ...
            $(`#product_total${productID}`).text($(`#product_quantity${productID}`).get(0).value * $(
                `#product_price${productID}`).val());
            calculateTotalPrice();
