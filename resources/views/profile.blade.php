...
<div class="container mx-auto p-4">
    <div class="bg-white  border border-red-100 shadow rounded-lg p-6">
        ...
        <div class="mt-4">
            ...
            <p><span class="font-medium">Name:</span> {{ $user->name?? 'Not available' }}</p>
            <p><span class="font-medium">Contact Number:</span> {{ $user->phone ?? 'Not available' }}</p>
...
{{-- //Shipping Address  --}}
        <div class="cart_list">
            ...
            <div
                ...
                <p class="text-gray-700 dark:text-gray-400">Name: Customer</p>
