...
@section('title', $title ?? _trans('notice.Notice').' '._trans('common.Type'))
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        {!! breadcrumb(_trans('notice.Notice').' '._trans('common.Type'),['#'=>_trans('notice.Notice').' '._trans('notice.Board'),'category'=>_trans('common.Type')]) !!}
        <div class="app-ecommerce-category">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasSectionCategoryList"
                ...
                <div class="offcanvas-header py-4">
                    <h5 id="offcanvasEcommerceCategoryListLabel" class="offcanvas-title">{{_trans('common.Add').' '._trans('notice.Notice').' '._trans('common.Type')}}</h5>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCategoryEditModal"
                ...
                <!-- Offcanvas Header -->
                <div class="offcanvas-header py-4">
                    <h5 id="offcanvasEcommerceCategoryListLabel" class="offcanvas-title">{{_trans('common.Edit').' '._trans('notice.Notice').' '._trans('common.Type')}}</h5>
                    <button type="button" class="btn-close bg-label-secondary text-reset" data-bs-dismiss="offcanvas"
                            aria-label="Close"></button>
                </div>
                <!-- Offcanvas Body -->
                    ...
                    <form class="pt-0" id="updateTypeModal" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="edit_name"
                                   placeholder="Enter Notice Type Name" name="edit_name" aria-label="brand name" />
                        ...
                        <!-- Status -->
                        <div class="mb-4 ecommerce-select2-dropdown">
                            <label class="form-label">{{_trans('notice.Select type status')}}</label>
        ...
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                buttons: [
                    ...
                    {
                        text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add Notice Type</span>',
