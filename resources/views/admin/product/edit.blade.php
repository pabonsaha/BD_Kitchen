...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        {!! breadcrumb(_trans('common.Update').' '._trans('product.Products'),['#'=>_trans('product.Product').' '._trans('product.Management'),'product/index'=>_trans('product.Product'), 'product'=>_trans('common.Update').' '._trans('product.Products')]) !!}
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h5 class="card-tile mb-0">{{_trans('product.Product').' '. _trans('common.Information')}}</h5>
                            </div>
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-9">
                                ...
                                <div>
                                    ...
                                    <div class="form-control p-0 pt-1">
                                        ...
                                        <div class="product-editor border-0 pb-4" id="description">{!! $product->description !!}
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-4" id="specificationsContainer">
                                    <div class="row justify-content-between">
                                        <div class="col-6">
                                            <h6>{{_trans('common.Specifications')}}:</h6>
                                        </div>
                                        ...
                                        <div class="row mb-3 parentSpecifications">
                                            <div class="col-4">
                                                ...
                                                <input type = "text" class="form-control parentSpecificationsTitle"
                                                    ...
                                                    value="{{ $specification['title'] }}" name="specifications[title][]"
                                    ...
                                    @empty
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-8">
                                                <label class="form-label" for="ecommerce-product-name">{{_trans('common.Value')}}</label>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h5 class="card-title mb-0">{{_trans('common.Meta Value')}}</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="mb-3">
                                        <label class="form-label" for="ecommerce-product-name">{{_trans('common.Meta Title')}}</label>
                                        <input type="text" class="form-control" id="mata_title"
                                            value="{{ $product->meta_title }}" placeholder="Meta title"
                                            name="mata_title" aria-label="Product title" />
                                        <span class="text-danger metaTitleError error"></span>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="ecommerce-product-name">{{_trans('common.Meta Description')}}</label>
                                        <textarea class="form-control" placeholder="Meta Description" name="meta_description" id="meta_description"
                                            cols="30" rows="5">{{ $product->meta_description }}</textarea>
                                        <span class="text-danger metaDescriptionError error"></span>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="ecommerce-product-name">{{_trans('common.Meta Image')}}</label>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                {{-- <form action="/upload" class="dropzone needsclick" id="dropzone-basic">
                                    ...
                                    <div class="fallback">
                                        <input name="file" name="image" id="product_image" type="file" />
                                    </div>
                                </form> --}}
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 col ecommerce-select2-dropdown">
                                    <label class="form-label mb-1 d-flex justify-content-between align-items-center"
                                        for="discout_type">
                                        <span>{{_trans('product.Discount Type')}}</span>
                                    </label>
                                    <select id="discout_type" name="discount_type" class="select2 form-select"
                                        data-placeholder="Select Category">
                                        <option value="0" {{ $product->discount_type == 0 ? 'selected' : '' }}>{{_trans('common.Select').' '._trans('common.Option')}}</option>
                                        <option value="0" {{ $product->discount_type == 0 ? 'selected' : '' }}>{{_trans('product.No Discount')}}</option>
                                        <option value="1" {{ $product->discount_type == 1 ? 'selected' : '' }}>{{_trans('product.Percentage')}} %</option>
                                        <option value="2" {{ $product->discount_type == 2 ? 'selected' : '' }}>{{_trans('common.Fixed')}}
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <br />
                                    <small class="text-primary"><span class="text-danger">*</span>{{_trans("product.Don't need input if product don't have discount.")}}</small>
                                </div>
