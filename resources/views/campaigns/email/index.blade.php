...
@section('title', $title ?? _trans('marketing.Email') . ' ' . _trans('marketing.Campaign'))

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        {!! breadcrumb(_trans('marketing.Email') . ' ' . _trans('marketing.Campaign'), [
            '#' => _trans('marketing.Marketing'),
            'emailcampaign' => _trans('marketing.Email') . ' ' . _trans('marketing.Campaign'),
        ]) !!}
        <div class="app-ecommerce-category">
            ...
            <div class="card">
                <div class="d-flex gap-3 position-absolute ps-4 p-2 "
                    ...
                    <div class="form-group">
                        <label><strong>{{ _trans('common.Send') . ' ' . _trans('common.Status') }} :</strong></label>
                        <select id='sending_status' class="form-control filter_dropdown" style="width: 200px">
                            <option value="">
                                {{ _trans('common.Select') . ' ' . _trans('common.Send') . ' ' . _trans('common.Status') }}
                            </option>
                            <option value="1">{{ _trans('common.Send') }}</option>
                    ...
                    <table class="data-table table border-top">
                        <thead>
                            <tr>
                                ...
                                <th>{{ _trans('common.Send') . ' ' . _trans('common.Status') }}</th>
                ...
                <div class="modal-body">
                    <div class="text-center mb-2">
                        <h3 class="role-title mb-2">
                            {{ _trans('common.Create') . ' ' . _trans('common.Email') . ' ' . _trans('common.Campaign') }}
                        </h3>
                    </div>
                    <form id="createForm">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-add-new-role">
            <div class="modal-content p-3 p-md-5">
                ...
                <div class="modal-body">
                    <div class="text-center mb-2">
                        <h3 class="role-title mb-2">
                            {{ _trans('common.Edit') . ' ' . _trans('common.Email') . ' ' . _trans('marketing.Campaign') }}
                        </h3>
                    </div>
                    ...
                    <div class="col-12 text-center mt-2">
                        <button type="submit" class="btn btn-primary me-sm-3 me-1"
                            id="campaignUpdate">{{ _trans('common.Update') }}</button>
                        <button type="button" class="btn btn-label-secondary" data-bs-dismiss="modal"
                            aria-label="Close">{{ _trans('common.Cancel') }}</button>
                    </div>
                </div>
    ...
    <script>
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                buttons: [{
                    text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add Campaign</span>',
