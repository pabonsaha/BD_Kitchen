...
class ExpenseTypeController extends Controller
{
    ...
    public function update(Request $request){
        try {
            ...
            $expenseType->is_active  = $request->status;
            $expenseType->update();
            return response()->json(['message' => 'Expense Type Updated', 'status' => 200], 200);
        }catch (Exception $e){
    ...
    public function destroy(IdValidationRequest $request){
        ...
        try {
            $expenseType = ExpenseType::find($request->id);
            $expenseType->delete();
            return response()->json(['message' => 'Expense Type Deleted', 'status' => 200], 200);
