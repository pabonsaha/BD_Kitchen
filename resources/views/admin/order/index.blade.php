...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        {!! breadcrumb(_trans('order.Order').' '. _trans('order.List'),['#'=>_trans('order.Order').' '. _trans('product.Management'),'##'=>_trans('order.Customer').' '._trans('order.Order'), 'order'=>_trans('order.Order').' '. _trans('order.List')]) !!}
        <div class="app-ecommerce-category">
            <!-- Category List Table -->
            <div class="card">
                <div class="d-flex gap-3 position-absolute ps-4 p-2 " style="z-index: 100; margin-top: 10px; margin-left: 240px">
                    <div class="form-group">
                        <label><strong>{{_trans('order.Cart').' '._trans('common.Status')}} :</strong></label>
