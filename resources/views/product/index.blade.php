...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        {!! breadcrumb(_trans('product.Products') .' '. _trans('order.List'), ['#' => _trans('product.Product').' '._trans('product.Management'), 'products' => _trans('product.Product').' '._trans('order.List')]) !!}
        ...
        <div class="app-ecommerce-category">
            ...
            <div class="card">
                <div class="d-flex gap-3 position-absolute ps-4 p-2 " style="z-index: 100; margin-top: 10px; margin-left: 240px">
                    ...
                    <div class="form-group">
                        <label><strong>{{_trans('common.Seller') }} {{_trans('common.Type')}}: </strong></label>
                        <select id='role' class="form-control filter_dropdown" style="width: 200px">
                            <option value="">{{_trans('common.Select') }} {{_trans('common.Type')}}</option>
                            <option value="{{Role::DESIGNER}}">{{_trans('user.Designers')}}</option>
                            <option value="{{Role::MANUFACTURER}}">{{_trans('product.Manufacturer')}}</option>
