...
@section('title', $title ?? _trans('product.Unit'))
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        {!! breadcrumb(_trans('product.Unit').' '. _trans('order.List'),['#'=>_trans('product.Product').' '._trans('product.Management'),'unit'=>_trans('product.Unit').' '. _trans('order.List')]) !!}
        ...
        <div class="app-ecommerce-category">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEUnitList"
                ...
                <div class="offcanvas-header py-4">
                    <h5 id="offcanvasEcommerceCategoryListLabel" class="offcanvas-title">{{_trans('common.Add').' '._trans('product.Unit')}}</h5>
                    ...
                    <form class="pt-0" id="addModal" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ecommerce-category-title"
                                placeholder="{{_trans('product.Enter Unit name')}}" name="name" aria-label="Attribute Name" />
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasUnitEditModal"
                ...
                <!-- Offcanvas Header -->
                <div class="offcanvas-header py-4">
                    <h5 id="offcanvasEcommerceCategoryListLabel" class="offcanvas-title">{{_trans('common.Edit').' '. _trans('product.Unit')}}</h5>
                    <button type="button" class="btn-close bg-label-secondary text-reset" data-bs-dismiss="offcanvas"
                        aria-label="Close"></button>
                </div>
                <!-- Offcanvas Body -->
        ...
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                buttons: [
                    ...
                    {
                        text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">{{_trans("common.Add").' '._trans('product.Unit')}}</span>',
