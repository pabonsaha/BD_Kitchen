...
@section('title', $title ?? _trans('common.Event') .' '._trans('common.Type'))
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        {!! breadcrumb(_trans('common.Event') .' '._trans('common.Type'),['#'=>_trans('common.Event').' '._trans('expense.Management'),'category'=>_trans('common.Event').' '._trans('common.Type')]) !!}
        <div class="app-ecommerce-category">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasSectionCategoryList"
                ...
                <div class="offcanvas-header py-4">
                    <h5 id="offcanvasEcommerceCategoryListLabel" class="offcanvas-title">{{_trans('common.Add').' '._trans('common.Event').' '._trans('common.Type')}}</h5>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCategoryEditModal"
                ...
                <!-- Offcanvas Header -->
                <div class="offcanvas-header py-4">
                    <h5 id="offcanvasEcommerceCategoryListLabel" class="offcanvas-title">{{_trans('common.Edit').' '._trans('common.Event').' '._trans('common.Type')}}</h5>
                    <button type="button" class="btn-close bg-label-secondary text-reset" data-bs-dismiss="offcanvas"
                            aria-label="Close"></button>
                </div>
                <!-- Offcanvas Body -->
                <div class="offcanvas-body border-top">
                    <form class="pt-0" id="updateTypeModal" method="POST" action="{{route('event-management.type.update')}}">
                        @csrf
                        <!-- Title -->
                        <div class="mb-3">
        ...
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                buttons: [
                    ...
                    {
                        text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">{{_trans('common.Add').' '._trans('common.Event').' '._trans('common.Type')}}</span>',
