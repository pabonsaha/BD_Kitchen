        ...
        <div class="app-ecommerce-category">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEBrandList"
                ...
                <div class="offcanvas-header py-4">
                    <h5 id="offcanvasEcommerceCategoryListLabel" class="offcanvas-title">{{_trans('common.Add').' '._trans('portfolio.Inspiration')}} </h5>
                ...
                <div class="offcanvas-body border-top">
                    <form class="pt-0" id="addModal" method="POST">
                        ...
                        <div class="mb-4 ecommerce-select2-dropdown">
                            <label class="form-label">{{_trans('common.Select').' '._trans('common.Category')}}</label>
                            <select id="category_id" name="category_id" class="select2 form-select"
                                data-placeholder="Select category">
                                <option value="">{{_trans('common.Select').' '._trans('common.Section').' '._trans('common.Category')}}</option>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasBrandEditModal"
                ...
                <div class="offcanvas-body border-top">
                    <form class="pt-0" id="updateCategoryModal" method="POST">
                        <!-- Title -->
                        <div class="mb-3">
                            <label class="form-label" for="edit_name">{{_trans('common.Title')}}</label>
                        ...
                        <div class="mb-4 ecommerce-select2-dropdown">
                            <label class="form-label">{{_trans('common.Select').' '._trans('common.Section').' '._trans('portfolio.Category')}} </label>
        ...
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                buttons: [
                    ...
                    @if(hasPermission('inspiration_create'))
                    {
                        text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add Inspiration</span>',
