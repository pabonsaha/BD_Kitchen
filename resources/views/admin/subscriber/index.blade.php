...
@section('title', $title ?? _trans('subscriber.Subscribers'))

@section('content')

    <div class="container-xxl flex-grow-1 container-p-y">
        {!! breadcrumb(_trans('subscriber.Subscribers'), ['/subscriber/index'=> _trans('subscriber.Subscribers'), _trans('subscriber.Subscribers').' '._trans('common.List')]) !!}
        <div class="app-ecommerce-category">
            ...
            <div class="card">
                <div class="d-flex gap-3 position-absolute ps-4 p-2" style="z-index: 100; margin-top: 10px; margin-left: 240px">
                    ...
                    <div class="form-group">
                        <label><strong>{{_trans('contact.Replied')}}:</strong></label>
                        <select id='reply' class="form-control filter_dropdown" style="width: 200px">
                            <option value="">{{_trans('common.Select').' '._trans('common.Reply').' '._trans('common.Type')}} </option>
