...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('dashboard') }}" class="app-brand-link">
            <img src="{{ getFilePath(shopSetting()->logo) }}" alt="House Brand" height="60px" width="auto">
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        @if (hasPermission('product_management_read'))
            <li
                class="menu-item {{ openMenu(['category', 'brand', 'attribute', 'product', 'vendor', 'unit', 'bulkImport', 'bulkExport']) }}">
                ...
                <ul class="menu-sub">
                    ...
                    @if (hasPermission('brand_read'))
                        <li class="menu-item {{ activeMenu('brand') }}">
                            <a href="{{ route('brand.index') }}" class="menu-link">
                                <div data-i18n="{{ _trans('product.Brands') }}">{{ _trans('product.Brands') }}</div>
                            </a>
                        </li>
                    @endif
                    ...
                    @if (hasPermission('attribute_read'))
                        <li class="menu-item {{ activeMenu('attribute') }}">
                            <a href="{{ route('attribute.index') }}" class="menu-link">
                                <div data-i18n="{{ _trans('product.Attribute') }}">{{ _trans('product.Attribute') }}
                                </div>
                            </a>
                        </li>
                    @endif
                    ...
                    @if (hasPermission('manufacturer_read'))
                        <li class="menu-item {{ activeMenu('vendor') }}">
                    ...
                    @if (hasPermission('unit_read'))
                        <li class="menu-item {{ activeMenu('unit') }}">
                            <a href="{{ route('unit.index') }}" class="menu-link">
                                <div data-i18n="{{ _trans('product.Unit') }}">{{ _trans('product.Unit') }}</div>
                            </a>
                        </li>
                    @endif
                    ...
                    @if (hasPermission('bulk_import_read'))
                        <li class="menu-item {{ activeMenu('bulkImport') }}">
                            <a href="{{ route('bulkImport.index') }}" class="menu-link">
                                <div data-i18n="{{ _trans('product.Bulk') }} {{ _trans('product.Import') }}">
                                    {{ _trans('product.Bulk') }} {{ _trans('product.Import') }}</div>
                            </a>
                        </li>
                    @endif
                    ...
                    @if (hasPermission('bulk_export_read'))
                        <li class="menu-item {{ activeMenu('bulkExport.index') }}">
                            <a href="{{ route('bulkExport.index') }}" class="menu-link">
                                <div data-i18n="{{ _trans('product.Bulk') }} {{ _trans('product.Export') }}">
                                    {{ _trans('product.Bulk') }} {{ _trans('product.Export') }}</div>
                            </a>
                        </li>
                    @endif
        ...
        @if (hasPermission('event_management_read'))
            <li class="menu-item {{ openMenu(['event-management']) }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    ...
                    <div
                        data-i18n="{{_trans('common.Event')}} {{_trans('product.Management')}}">{{_trans('common.Event')}} {{_trans('product.Management')}}</div>
                </a>
                <ul class="menu-sub">
                    ...
                    @if(hasPermission('event_type_read'))
                        <li class="menu-item {{ activeMenu('event-management.type.index') }}">
                            <a href="{{ route('event-management.type.index') }}" class="menu-link">
                                <i class="menu-icon ti ti-calendar-event"></i>
                                <div data-i18n="{{_trans('common.Event') .' '._trans('common.Type')}}">{{_trans('common.Event') .' '._trans('common.Type')}}</div>
                            </a>
                        </li>
                    @endif
                    ...
                    @if(hasPermission('event_read'))
                        <li class="menu-item {{ activeMenu('event-management.event.calender') }}">
                            <a href="{{route('event-management.event.calender')}}" class="menu-link">
                                <i class="menu-icon ti ti-calendar-event"></i>
                                <div data-i18n="{{_trans('common.Calendar')}}">{{_trans('common.Calendar')}}</div>
                            </a>
                        </li>
                    @endif
